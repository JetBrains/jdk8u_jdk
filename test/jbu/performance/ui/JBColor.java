...
public class JBColor extends Color {
  ...
  private static volatile boolean DARK = true;
  ...
  public static final JBColor white = new JBColor(Color.white, Color.white);
  ...
  public static Color background() {
    return new JBColor(Color.black, Color.black);
  }

  public static Color border() {
    return new JBColor(Color.gray, Color.gray);
  }
}
